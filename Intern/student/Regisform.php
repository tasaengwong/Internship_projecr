...
<body ng-controller="Ctrl">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse " id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ml-auto">
          <li class="nav-item"><a class="nav-link js-scroll-trigger" href="../Homepage/home.html">หน้าแรก</a>
          </li>
          <li class="nav-item"><a class="nav-link js-scroll-trigger" href="../student/Regisform.php">ยื่นคำร้องฝึกงาน</a></li>
          <!-- <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#calender">Calender</a></li>
  ...
  <div class="container ">
    ...
    <hr><br>
    <p>คำชี้แจง : แบบฟอร์มนี้จัดทำขึ้นเพื่อขอข้อมูลเบื้องต้นการฝึกประสบการณ์วิชาชีพ นักศึกษา
    </p>
    <!-- ข้อมูลนักศึกษา -->
    ...
    <form class="form-inline ">
      <div class="form-group" method="get">
        ...
        <select name="majorselect" class="custom-select col-sm-5" ng-model="Reg.major" ng-optin=" x for x in major">
    ...
    <form class="form-group" method="post">
      ...
      <form class="form-inline">
        <div class="form-group">
          ...
          <input name="comp_id" id="industry_name" type="text" class="form-control col-sm-4" ng-model="Reg.comp_name">&nbsp;
          <label for="Address">ที่อยู่: </label>&nbsp;
          <textarea name="adress" id="address" class="form-control col-md-4 " rows="3" ng-model="Reg.comp_address"></textarea>
        </div>&nbsp;&nbsp;&nbsp;
      </form>&nbsp;&nbsp;
      <form class="form-group  ">

        <div class="form-inline">
          <label for="industry_provinces">จังหวัด: </label>&nbsp;
          <input class="form-control col-md-2" ng-model="Reg.comp_province"></input>&nbsp;
          <label for="industry_zipcode">รหัสไปรษณีย์: </label>&nbsp;
          <input class="form-control col-md-2 " ng-model="Reg.comp_zipcode"></input>&nbsp;
        </div>
      </form>
      <form class="form-inline">
        <div class="form-group">
        ...
        <div class="bnt col-11">
          <hr>
          <button class="btn btn-success" type="submit" ng-click="save()"><i class="fas fa-plus-circle">&nbsp;</i>Save</button>
        </div>
      </form>
